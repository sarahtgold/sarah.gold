...
NARDOVE.Main = (function()
{
	var canvas 				= $("#can_canvas"),
		ctx 				= document.getElementById("can_canvas").getContext( "2d" ),
		img 				= new Image(),
		movingParticles 	= [],
		caParticles			= [],
		borderParticles		= [],
...
["#064F51", "#1e7d80", "#27A3A0", "#6FCCDD"],
["#CFF09E", "#A8DBA8", "#79BD9A", "#3B8686"], 
["#FFBF52", "#EDCC82", "#DCD8B2", "#FFD230"], 
["#8537FF ", "#5800B5", "#8C7EFF", "#9EC5FF"], 
["#8D62BC ","#453E74", "#D9F7FF" ,"#232D36"],
							],
	...
	{
		$.ajax({
			src: "barometerbits/can.svg",
			url: "barometerbits/can.svg",
			dataType: "xml",
			success: setup,
			error: function()
					{
	...
	function renderTriangles( inColor )
	{
		...
		for ( t in triangles )
		{
			...
			if ( inColor )
			{
				...
				//{
				ctx.fillStyle = ( triangleCount < i ) ? " )" : "rgb(" + R + ", " + G + ", " + B + ")";
	...
	function clearCanvas()
	{
		...
		//ctx.globalAlpha = 1;
		//ctx.fillStyle = "black"; // "rgb( 241, 241, 241 )";
